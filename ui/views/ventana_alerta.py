...
def barra_error_mensaje(texto):
    barra=ft.SnackBar(ft.Text(texto), bgcolor=constants.COLOR_BOTON_ERROR)
    return barra

def barra_ok_mensaje(texto):
    barra=ft.SnackBar(ft.Text(texto), bgcolor=constants.COLOR_BOTON_EXITO)
    return barra

def barra_info_mensaje(texto):
    barra=ft.SnackBar(ft.Text(texto), bgcolor=constants.COLOR_BORDE_CLARO)
    return barra
